...
Conclude:
Yes, the coefficients obtained are the same as previous, and pass a visual "sanity check". 
...
```
  ...
  Conclude: 
  Sanity Check: the estimated life expectancy for this year matches with what we can see on the plot. 